...
# Modified by Jennie Lees to include Search method and
# operate with Google AppEngine - Code from other online authors
# may be included - credit TBD
...
class Api(object):
  ...
  def Search(self, terms=None, from_user=None, to_user=None, hashtag=None, since_id=None, lang=None):
     ...
     if lang:
       params['lang'] = lang
     # Return 100 results (the maximum)
     params['rpp'] = 100
